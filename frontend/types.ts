...
// Added to fix missing export error in Home.tsx
...
export interface GameRoom {
  ...
  // Use the newly defined PlayerPoolItem type
  ...
  auction: {
    ...
    currentSetNo: number | null; // Changed from number to number | null to allow initialization in Home.tsx
    ...
    // Added to support initialization in Home.tsx and match usage patterns
    rtmTimeLeft?: number;
    slabIndex?: number;
    playerIndex?: number;
